  ...
  <tr>
    <td>
      <ul>
        ...
        <li>Discrete events determine population dynamics over time.</li>
      </ul>
    </td>
    <td width="45%">
...
<img src="../img/latent1.6.compare.png" width="500px"/>

```{r echo=FALSE, eval=FALSE}
tf <- "~/git/bayroot/data/latent1.3.cens.nwk.fas.ft2.nwk"
