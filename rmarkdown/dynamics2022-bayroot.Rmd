  ...
  <tr>
    <td>
      <ul>
        ...
        <li>Assumes the tree is known without error.</li>
      </ul>
    </td>
    <td width="45%">
...
<table>
  <tr>
    <td><img src="../img/cellular-model.png" width="350px"/></td>
    <td><img src="../img/cellular-model-dynamics.png" width="350px"/></td>
  </tr>
</table>
...
<img src="../img/latent1.1.compare.png" width="300px"/>

```{r echo=FALSE, eval=FALSE}
tf <- "~/git/bayroot/data/latent1.1.cens.nwk.fas.ft2.nwk"
...
png("~/slides/img/latent1.1.compare.png", width=150*5, height=150*5, res=150)
par(mar=c(5,5,1,1))
