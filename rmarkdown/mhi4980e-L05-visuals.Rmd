...
A tree diagram (tashj&imacr;r) of the disciplines (al-fun&umacr;n) of human knowledge, from the Na&#7827;m al-sul&umacr;k.

<img src="../img/tashjir-nazm-al-suluk.png" width="800px"/>

<small>
Copyright Topkapi Sarayi M&uuml;zesi K&uuml;t&uuml;phanesi, Instanbul.
</small>
...
## Channels of data visualization

* Some channels of data visualization according to Wilke:
  * position
  * shape
  * size
  * colour
  * line width, type
* Note, Wilke calls these "aesthetics", but I prefer channels.
