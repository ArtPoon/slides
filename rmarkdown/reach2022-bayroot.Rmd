---
title: "Bayesian sampling of integration dates in the latent HIV reservoir"
author: 'Roux-Cil Ferreira, Emmanuel Wong and Art Poon'
  ...
  <tr>
    <td>
      ...
      <ul>
        ...
        <li>Requires extensive sampling of HIV-1 plasma RNA pre-ART - uncertainty in the tree and location of root.</li>
      </ul>
    </td>
    <td width="40%">
  ...
  <tr>
    <td>
      ...
      <ul>
        ...
        <li>May be more robust to uncertainty in tree (dating is a function of lineage-specific divergence).</li>
        </ul>
      </ul>
    </td>
    <td width="40%">
  ...
  <tr>
    <td>
      <ul>
        ...
        <li>Proviral sequences can be mapped to post-ART period or the future (<i>right</i>, red zone).</li>
        </ul>
...
<table>
  <tr>
    ...
    <td width="60%">
      ...
      <small><small>Step 180</small></small>
      <img src="../img/bayroot-state1000.png"/>
      <small><small>Step 19980</small></small>
    </td>
  </tr>
</table>
    ...
    <td>
      <ul>
        ...
        <ul>
          ...
          <li>Virus replication completely blocked by ART initiation.</li>
        </ul>
...
<table>
  <tr>
    <td>
    When clock signal is strong, advantage of `bayroot` is largely due to prior information about ART initiation (dashed line).
      <img src="../img/bayroot-compare1.svg" height="450px"/>
      <small>
    ...
    <td width="35%">
      ...
      <small>
      Paired Wilcoxon sign-rank test, $P=3.55\times 10^{-4}$, $n=50$.
      </small>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <ul>
        <li>Advantage of `bayroot` driven by prior information about the root.</li>
        <ul><li>With a less informative prior, `bayroot` results become similar to RTT.</li></ul>
      </ul>
      <img src="../img/bayroot-compare2.svg" height="400px"/>
    </td>
    <td>
