...
* Previous results assumed near-complete sampling of infected population; if we reduced sampling to 50%:
...
* Variation in sampling rates can create false MMPP clusters
...
<table>
<tr><td style="vertical-align:middle">ClusterPicker</td><td>
  <img src="/img/realtree-cpicker.svg" height="220"/>
</td></tr>
<tr>
  <td style="vertical-align:middle">MMPP</td>
  <td><img src="/img/realtree-mmpp.svg" height="220"/></td>
</tr>
</table>
