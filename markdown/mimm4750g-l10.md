...
* Population size influences the influx of new mutations.
* Population size also influences the probability that a new mutation will "fix" (genetic drift).

---

# Generation times

* Pathogens produce more generations 
