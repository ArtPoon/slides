...
<tr>
  <td style="font-size: 20pt; vertical-align:middle;">
    ...
    <ul>
    <li>Influenza A virus (IAV) [hemagglutinin](https://en.wikipedia.org/wiki/Hemagglutinin_(influenza)) (HA) is responsible for binding host cell receptor.</li>
    <li>HA binds [sialic acids](https://en.wikipedia.org/wiki/Sialic_acid) in upper respiratory tract - name stems from clumping of blood cells.</li>
